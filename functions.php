<?php
	// resousreces support
	function kitchen_css(){
		wp_enqueue_style('style', get_stylesheet_uri());
	}
	add_action('wp_enqueue_scripts', 'kitchen_css');
	...
	function kitchen_setup(){
		...
		register_nav_menus(
			array(
				'primary' => __('Direct Kitchen Menu')
			)
		);
		// add featured image support
		add_theme_support('post-thumbnails');
		add_image_size('product-thumbnail', 290, 200, true);
		add_image_size('about-thumbnail', 400, 284, true);
